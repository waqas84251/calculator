const numericalIntegrate = () => {}; const numericalSummation = () => {}; const calculateLogBase = () => {}; const mathFactorial = () => {}; const lastAnswer = 0; const config = {angle: 'Deg'}; import { differentiate as numericalDifferentiate } from './src/mathUtils.js';
...
console.log(processForEval('d/dX(7‡7)', {}, 'Deg'));